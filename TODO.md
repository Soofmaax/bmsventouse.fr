...
- [ ] (P1) GLOBAL — introduire/utiliser des utilitaires de spacing (margin/padding) pour remplacer les `style="margin-..."` inline — vérifier via une recherche globale qu’il ne reste plus de styles inline de marge/padding dans les fichiers HTML.
